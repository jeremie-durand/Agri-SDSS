...
# ------------------------------------------
# Test cases for the logging helpers
# ------------------------------------------
...
def test_generate_processing_report_logs_summary_header():
    ...
    from gis_pipeline.core.utils import generate_processing_report
...
def test_add_section_to_logger_logs_title():
    ...
    from gis_pipeline.core.utils import add_section_to_logger
...
def test_add_process_to_logger_logs_with_prefix():
    ...
    from gis_pipeline.core.utils import add_process_to_logger
