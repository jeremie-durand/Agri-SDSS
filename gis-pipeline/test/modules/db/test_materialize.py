"""Unit tests for gis_pipeline.modules.db.materialize."""

import duckdb
import geopandas as gpd
import pytest
from gis_pipeline.modules.db.materialize import (
...
def sample_geoparquet_path(tmp_path):
    ...
    rejects on real production data (see materialize.py docstring).
    """
    data = {
        "gid": [1, 2, 3],
