...
This pipeline is part of a larger reserch projet and forms the basis of the backend architecture for the plateform descibed here: https://rqrad.com/projet/developpement-dun-systeme-daide-a-la-decision-pour-determiner-le-potentiel-daccumulation-de-matiere-organique-du-sol-au-quebec-et-les-pratiques-pour-latteindre/


Currently, only the local version is availaible.

## Subsections
- [Docs for local deployment of eoAPI](./eoapi-template/README.md)
- [Docs for pipeline and API logic](./docs/)

## Tools used in API
| Tool            | Purpose                                                     |
|-----------------|-------------------------------------------------------------|
| **eoAPI**       | Backend framework exposing STAC-compliant metadata services |
| **eoAPI-template** | Template used to deploy STAC API services locally         |
