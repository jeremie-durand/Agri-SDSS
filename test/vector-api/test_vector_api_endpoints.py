...
def sample_collection_response(vector_api_url_fixture):
    ...
    return {
        ...
        "links": [
            {
                "href": f"{base}/collections/public.sud_du_quebec_4326",
                "rel": "self",
                "type": "application/json",
            },
            {
                "href": f"{base}/collections/public.sud_du_quebec_4326/items",
                "rel": "items",
    ...
    return {
        "collections": [
            ...
            },
            {
                ...
                "links": [
                    {
                        "href": f"{base}/collections/public.bdppad_2024_4326_sample_stac",
                        "rel": "self",
                        "type": "application/json",
                    }
                ],
...
@pytest.mark.mocked
@responses.activate
def test_mocked_vector_api_responds(vector_api_url_fixture):
...
def test_mocked_get_all_collections(collections_list_response, vector_api_url_fixture):
    ...
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections",
        json=collections_list_response,
        status=200,
    )

    resp = requests.get(f"{vector_api_url_fixture}/collections")
...
def test_mocked_get_collection_info(sample_collection_response, vector_api_url_fixture):
    """Test GET /collections/{collectionId} endpoint."""
    collection_id = "public.sud_du_quebec_4326"
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections/{collection_id}",
        json=sample_collection_response,
        status=200,
    )

    resp = requests.get(f"{vector_api_url_fixture}/collections/{collection_id}")
...
def test_mocked_vector_api_collection_items(
    ...
    """Test GET /collections/{collectionId}/items endpoint."""
    collection_id = "public.sud_du_quebec_4326"
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections/{collection_id}/items",
        json=sample_feature_collection,
        status=200,
    )

    resp = requests.get(f"{vector_api_url_fixture}/collections/{collection_id}/items")
...
def test_mocked_get_specific_feature(
    ...
    """Test GET /collections/{collectionId}/items/{featureId} endpoint."""
    collection_id = "public.sud_du_quebec_4326"
    feature_id = "region-1"
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections/{collection_id}/items/{feature_id}",
...
def test_mocked_collection_items_with_limit(vector_api_url_fixture):
    ...
    resp = requests.get(
        f"{vector_api_url_fixture}/collections/{collection_id}/items?limit=5"
    )
...
def test_mocked_collection_items_with_bbox(vector_api_url_fixture):
    ...
    bbox = "-75,45,-74,46"
    resp = requests.get(
        f"{vector_api_url_fixture}/collections/{collection_id}/items?bbox={bbox}"
    )
...
def test_mocked_collection_items_with_pagination(vector_api_url_fixture):
    ...
    paginated_response = {
        ...
        "links": [
            {
                "href": f"{vector_api_url_fixture}/collections/{collection_id}/items?offset=30&limit=10",
                "rel": "next",
                "type": "application/geo+json",
            }
        ],
    ...
    resp = requests.get(
        f"{vector_api_url_fixture}/collections/{collection_id}/items?limit=10&offset=20"
    )
...
def test_mocked_collection_not_found(vector_api_url_fixture):
    ...
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections/nonexistent",
        json={"detail": "Collection not found"},
        status=404,
    )

    resp = requests.get(f"{vector_api_url_fixture}/collections/nonexistent")
...
def test_mocked_feature_not_found(vector_api_url_fixture):
    ...
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections/{collection_id}/items/nonexistent",
...
def test_mocked_invalid_bbox(vector_api_url_fixture):
    ...
    resp = requests.get(
        f"{vector_api_url_fixture}/collections/{collection_id}/items?bbox=invalid"
    )
...
def test_mocked_geojsonseq_format(vector_api_url_fixture):
    ...
    resp = requests.get(
        f"{vector_api_url_fixture}/collections/{collection_id}/items?f=geojsonseq"
    )
...
def test_mocked_query_parameters_validation(vector_api_url_fixture):
    ...
    for case in test_cases:
        ...
        resp = requests.get(
            f"{vector_api_url_fixture}/collections/{collection_id}/items?{query_params}"
        )
...
def test_large_collection_response_time(vector_api_url_fixture):
    ...
    resp = requests.get(
        f"{vector_api_url_fixture}/collections/{collection_id}/items?limit=1000"
    )
...
def test_ogc_api_features_compliance(vector_api_url_fixture):
    ...
    endpoints = [
        "/collections",
        "/collections/public.sud_du_quebec_4326",
        "/collections/public.sud_du_quebec_4326/items",
    ]
...
def test_crs_support(vector_api_url_fixture):
    ...
    responses.add(
        responses.GET,
        f"{vector_api_url_fixture}/collections/public.sud_du_quebec_4326",
