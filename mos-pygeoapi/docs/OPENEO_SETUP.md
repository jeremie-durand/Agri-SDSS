...
Tokens live in `mos-pygeoapi/config/openeo-config/`:
...
The mos-pygeoapi service authenticates with openEO in this order:
...
1. Check that `refresh-tokens.json` exists in `mos-pygeoapi/config/openeo-config/`
